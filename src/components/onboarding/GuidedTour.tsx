...
const ANALYTICS_STEPS = [
  {
    ...
    popover: {
      title: 'Навигация',
      description:
        'Меню слева сворачивается в узкую полосу и разворачивается обратно. В группе «Аналитика» — подразделы: Рентабельность, ABC-анализ и Динамика; ниже — Товары и Налоговые ставки.',
      side: 'right' as const,
  ...
  },
  {
    ...
    popover: {
      title: 'Профиль',
      description:
        'Личный кабинет: смена пароля и подключение API ключа Wildberries — без ключа данные загружаться не будут. Рядом — переключатель темы и выход.',
      side: 'right' as const,
      align: 'start' as const,
    },
  },
