  ...
  return (
    <div className="min-h-screen bg-app text-app">
      ...
      <footer className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
        <div className="bg-gradient-to-r from-primary to-primary-dark rounded-2xl p-8 md:p-10 text-center mb-12">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-app-muted">
          ...
          <div className="flex gap-6">
            <a href="#" className="hover:text-app transition">Пользовательское соглашение</a>
            <a href="#" className="hover:text-app transition">Политика конфиденциальности</a>
          </div>
        </div>
      </footer>
